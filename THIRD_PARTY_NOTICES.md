...
| Project | Reference version | Purpose | Licence |
|---|---:|---|---|
...
| Foundry | v1.7.1 | local build, tests, fuzzing, invariants and scripts | Apache-2.0 / MIT components |

The OpenZeppelin and forge-std source revisions are pinned in
`packages/fx-contracts/Makefile`. The Foundry version above records the release
reference toolchain.
