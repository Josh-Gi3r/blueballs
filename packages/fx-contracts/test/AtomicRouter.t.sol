...
contract AtomicRouterTest {
    ...
    function _twoFills() internal returns (FxTypes.MakerFill[] memory fills) {
        ...
        fills[0] =
            _makerFill(makerOne, MAKER_ONE_PK, 40 ether, 80 ether, 40 ether, bytes32("maker-one"));
        fills[1] =
            _makerFill(makerTwo, MAKER_TWO_PK, 60 ether, 114 ether, 60 ether, bytes32("maker-two"));
    }
