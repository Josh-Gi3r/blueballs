...
export function validateAdmission(payload) {
  if (!payload || typeof payload !== 'object') throw new TypeError('admission payload is required');
  return {
    ...
    policySnapshotHash: requireBytes32(payload.policySnapshotHash, 'policySnapshotHash'),
  };
}
