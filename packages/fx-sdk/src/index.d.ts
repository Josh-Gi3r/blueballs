...
export class BlueballsFxClient {
  ...
  referenceScenario(): Promise<{
    current: ReferenceMarket;
  ...
  previewReferenceTrade(
    request: PublicTradeRequest,
  ): Promise<PublicReferenceTrade>;
  reserveReferenceTrade(
    request: PublicTradeRequest,
  ): Promise<PublicReferenceTrade>;
  ...
  cancelOrder(
    orderHash: string,
    options?: { onChainInvalidated?: boolean },
