...
A release is an auditable mapping from source commit to artifacts. Release notes must identify breaking changes, migrations, known limitations and security-relevant changes.
