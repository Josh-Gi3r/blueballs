...
| Evidence | Location |
|---|---|
| aggregate release gate | `.github/workflows/fx-release-gate.yml` |
| visual render gate | `.github/workflows/fx-visual.yml` |
| reference release bundle | `.github/workflows/reference-release.yml` |
