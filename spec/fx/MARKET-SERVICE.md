...
The market service is durable by default. An in-memory order book is permitted only in tests.
...
The automated tests prove at least:
...
## 17. Outside the market service

The market service does not implement:
...
Those responsibilities belong to the policy, pricing, liquidity and settlement
layers. The market service ensures eligible signed liquidity can be stored,
reserved, matched and handed safely to the atomic kernel.
