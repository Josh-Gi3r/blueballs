...
test("production cards, receiving details, onboarding and transfers execute through the provider protocol", async (t) => {
  ...
  // Production funding is not allowed through the sandbox credit endpoint. A
  // credit-line draw is a real balanced product flow and gives this account a
  // balance without using POST /accounts/:id/credit.
