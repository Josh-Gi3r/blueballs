/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 33cd56c3d9dec66653d3a8668da713d4)
// Runtime types generated with workerd@1.20260804.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
	BUILDER_SOURCE_RATE_LIMITER: RateLimit;
	BUILDER_TENANT_RATE_LIMITER: RateLimit;
	AI: Ai;
	ASSETS: Fetcher;
	BLUEBALLS_GIT_SHA: "development";
	BUILDER_AGENT_ENABLED: "true";
	BUILDER_DAILY_REQUEST_LIMIT: "30";
	BUILDER_GLOBAL_DAILY_REQUEST_LIMIT: "300";
	BUILDER_MAX_COMPLETION_TOKENS: "800";
	NeobankBuilder: DurableObjectNamespace<import("./workers/site/index").NeobankBuilder>;
	BUILDER_BUDGET: DurableObjectNamespace<import("./workers/site/index").BuilderBudget>;
	API: Fetcher /* blueballs-api */;
	FX: Fetcher /* blueballs-fx */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/site/index");
		durableNamespaces: "NeobankBuilder" | "BuilderBudget";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BLUEBALLS_GIT_SHA" | "BUILDER_AGENT_ENABLED" | "BUILDER_DAILY_REQUEST_LIMIT" | "BUILDER_GLOBAL_DAILY_REQUEST_LIMIT" | "BUILDER_MAX_COMPLETION_TOKENS">> {}
}
