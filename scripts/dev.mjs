...
const procs = [
  ...
  },
  {
    ...
    env: {
      ...
      CORS_ORIGINS: process.env.CORS_ORIGINS ?? "http://localhost:5280,http://127.0.0.1:5280",
  ...
  },
  {
    ...
    env: {
      ...
      FX_NODE_DATA_DIR: process.env.FX_NODE_DATA_DIR ?? join(ROOT, ".data", "fx-reference"),
    },
  },
];
