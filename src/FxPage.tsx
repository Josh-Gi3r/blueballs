...
import { ComplianceModelGraphic, DeploymentBlueprints, FiatEdgeGraphic, FinalityGraphic, LiquidityGraphic, MasterArchitecture, OwnMarketGraphic, ProviderParticipation, TreasuryGraphic } from "./fx/ArchitectureStory";
...
export default function FxPage() {
  ...
  return <div className="fxp">
    <section className="fxp-hero"><div className="fxp-hero-copy"><div className="fxp-hero-top"><Label>STABLECOIN FX</Label><span className="fxp-hero-open">OPEN SOURCE · SELF-HOSTABLE</span></div><h1>Build FX into your financial product.</h1><p>Start with providers. Add your own market, counterparties and treasury as you grow. Keep fiat at the edges and control more of the execution over time.</p><div className="fxp-hero-proof"><div><span>START</span><b>Connect existing rails and liquidity.</b></div><div><span>GROW</span><b>Internalise flow and connect firms directly.</b></div><div><span>OWN</span><b>Run the market and control the economics.</b></div></div></div><div className="fxp-hero-phone"><ProductPhone/></div></section>
