...
import ReceivingDetails, {
  meta as ReceivingDetailsMeta,
} from "./receiving-details";
...
export const JOURNEYS: {
...
}[] = [
  {
    id: "onboarding",
    label: "Onboarding",
    blurb: "Create a customer, move through verification and open an account.",
  },
  {
    id: "funding",
    label: "Funding",
    blurb:
      "Show customers how to add money through a configured payment rail or wallet.",
  },
  {
    id: "spending",
    label: "Spending",
    blurb:
      "Issue a card, apply controls and show the resulting authorisation decision.",
  },
  {
    id: "payout",
    label: "Payout",
    blurb:
      "Create a recipient and destination, then follow a transfer through to settlement.",
  },
  {
    id: "product",
    label: "More products",
    blurb: "See additional customer experiences powered by the Blueballs API.",
  },
];
...
export const byJourney = (j: ScreenMeta["journey"]) =>
  SCREENS.filter((s) => s.meta.journey === j);
