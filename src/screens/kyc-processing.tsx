...
const steps: { title: string; sub: string; status: StepStatus }[] = [
  {
    ...
    sub: "Customer record created",
    status: "completed",
  },
  {
    title: "Compliance state",
    sub: "Sandbox check recorded",
    status: "completed",
  },
  {
    title: "Identity verification",
    sub: "Document review in progress",
    status: "pending",
  },
];
  ...
  return (
    <div
      style={{
        ...
        borderRadius: 999,
        flexShrink: 0,
        border: "2.5px solid #DDE1E8",
        borderTopColor: "#0868FF",
    ...
    >
      ...
      <div style={{ padding: "14px 20px 10px" }}>
        ...
        >
          ...
          >
            <div
              style={{ width: "66%", height: "100%", background: "#0868FF" }}
            />
          </div>
          <div style={{ fontSize: 12, color: "#B9BFCC" }}>
            2 of 3 sandbox steps complete
          </div>
        </div>
      </div>
      <div
        ...
        {steps.map((s, i) => (
          <div
            ...
            style={{
              ...
              alignItems: "center",
              gap: 12,
              ...(i === steps.length - 1 ? { padding: "12px 0" } : rowB),
            }}
          >
            ...
            <div
              style={{
                ...
                fontSize: 9.5,
                letterSpacing: "0.1em",
                color: s.status === "completed" ? "#2E7D53" : "#0868FF",
              }}
            >
      ...
      >
        Lifecycle status only — the decision is set separately once review
        finishes.
      </div>
    </div>
  );
