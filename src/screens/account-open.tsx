  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "20px 20px 14px" }}>
        ...
        >
          €0<span style={{ color: "#8A91A2" }}>.00</span>
        </div>
        <div style={{ fontSize: 12.5, color: "#7A8296", marginTop: 4 }}>
          Account opened moments ago
        </div>
      </div>
      <div
        style={{
      ...
      >
        ...
        >
          <div>
            ...
            <div style={{ fontFamily: MONO, fontSize: 14, marginTop: 2 }}>
        ...
        >
          Sample identifiers generated with this sandbox account. They cannot
