        ...
        >
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 13.5, fontWeight: 500 }}>
              Wallet provisioning not connected
            </div>
            <div style={{ fontSize: 11.5, color: "#7A8296" }}>
              Illustrative action for a future card-provider adapter
            </div>
          </div>
...
export const meta: ScreenMeta = {
  ...
  title: "Card issued",
  blurb:
    "Shows a sandbox virtual-card record. It is not connected to a card network.",
