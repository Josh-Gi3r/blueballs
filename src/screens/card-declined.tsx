    ...
    >
      ...
      <div style={{ padding: "0 20px", width: "100%" }}>
        <div style={{ ...white, borderRadius: 14, padding: "14px 16px" }}>
          ...
          >
            You froze this card on 3 Aug. Nothing can be charged to it until
            it's unfrozen — even if the transaction would otherwise be within
            limits.
          </div>
        </div>
      </div>
      ...
      <div style={{ padding: "10px 20px 0", width: "100%" }}>
        ...
        >
          ...
          <span style={{ fontFamily: MONO, color: "#07144F" }}>05</span>
        </div>
      </div>
