  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "20px 20px 14px" }}>
        ...
        >
          €23,402<span style={{ color: "#8A91A2" }}>.10</span>
        </div>
        <div
          style={{
            display: "inline-flex",
        ...
        >
          <span>↓</span>
          <span>+ €5,000.00 just credited</span>
        </div>
      </div>
      ...
      >
        ...
        {txns.map((t) => (
          <div
            key={t.name}
            style={{ display: "flex", alignItems: "center", gap: 12, ...rowB }}
          >
            <div
              style={{
                width: 32,
                ...
                alignItems: "center",
                justifyContent: "center",
                background: t.inbound ? "#EAF4FF" : "#F0F2F7",
                color: t.inbound ? "#0647E8" : "#454B5C",
                fontSize: 13,
              }}
            >
              {t.inbound ? "↓" : "↑"}
            ...
            <div style={{ fontSize: 13.5, fontWeight: 600, color: t.color }}>
              {t.amount}
            </div>
          </div>
        ))}
...
export const meta: ScreenMeta = {
  ...
  code: 'fetch("/v2/accounts/acc_92f", {\n  headers: { "x-api-key": key }\n}).then((response) => response.json());',
};
