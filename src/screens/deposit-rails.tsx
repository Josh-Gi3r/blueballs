  ...
  return (
    ...
    >
        ...
        {rails.map((r) => {
          ...
          return (
            <div
              ...
              style={{
                borderRadius: 14,
                border: `1px solid ${sel ? "#0868FF" : "#E3E6EE"}`,
                background: sel ? "#EAF4FF" : "#FFFFFF",
                padding: "12px 15px",
              }}
            >
              <div
      ...
      >
        ...
        >
          <span>Selected</span>
          <span style={{ color: "#07144F" }}>SEPA Instant · Free</span>
        </div>
        <div
          style={{
            background: "#07144F",
...
export const meta: ScreenMeta = {
  ...
  code: 'fetch("/v2/rails").then((response) => response.json());',
};
