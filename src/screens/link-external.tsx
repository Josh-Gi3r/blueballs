    ...
    >
      ...
      >
        {fields.map((f) => (
          <div
            key={f.k}
            style={{ ...white, borderRadius: 14, padding: "10px 15px" }}
          >
            <div style={label}>{f.k}</div>
            <div style={{ fontFamily: MONO, fontSize: 14.5, marginTop: 4 }}>
              {f.v}
            </div>
          </div>
        ))}
      ...
      <div style={{ padding: "4px 20px 0" }}>
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 13, fontWeight: 600, color: "#8A6D2F" }}>
              Name check: no match
            </div>
            <div
              style={{
            ...
            >
              You entered "Rina Aoki" — the bank holds "R. Aoki Design Ltd" on
              this account. Not an error: confirm the details and link anyway,
              or fix the name.
            </div>
          </div>
        </div>
