...
export default function ReceivingDetails() {
  return (
    ...
    >
      ...
      >
        Sample receiving fields for the reference account. They cannot receive
        real payments.
      </div>
          ...
          {actions.map((a, i) => (
            <div
              ...
              style={{
                ...
                fontWeight: 500,
                ...(i === 0
                  ? { background: "#07144F", color: "#FFFFFF" }
                  : { ...white, color: "#454B5C" }),
              }}
            >
              {a}
...
export const meta: ScreenMeta = {
  ...
  code: 'fetch("/v2/accounts/acc_92f/details", {\n  headers: { "x-api-key": key }\n}).then((response) => response.json());',
};
