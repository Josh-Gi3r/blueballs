      ...
      <div className="fxh-grid">
        ...
        <div style={{ padding: "44px 46px 40px", display: "flex", flexDirection: "column", gap: 22 }}>
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            ...
            <a href="/contact" style={{ fontSize: 14, fontWeight: 500, padding: "13px 22px", borderRadius: 10, background: "#FFFFFF", color: "#07144F", border: "1px solid #D7DBE4" }}>Source release status</a>
          </div>
