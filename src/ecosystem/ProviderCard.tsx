...
export default function ProviderCard({ provider }: { provider: Provider }) {
  ...
  return <article className="eco-provider-card">
    ...
    <div className="eco-provider-access">
      ...
      <div><small>TECHNICAL STATUS</small><b>{provider.technicalStatus}</b></div>
    </div>
    <div className="eco-provider-modules"><small>RELATIONSHIP · AS OF {provider.asOf}</small><span>{provider.relationshipStatus}</span></div>
