...
const docSlug = (name: string) =>
  "doc-fam-" + name.toLowerCase().replace(/[^a-z0-9]+/g, "-");
...
function H({
  ...
  return (
    <As
      style={{ ...style, ...(h ? hover : {}), ...(f ? focus : {}) }}
      onClick={onClick}
      type={type}
      onMouseEnter={() => hover && setH(true)}
      onMouseLeave={() => hover && setH(false)}
      onFocus={() => focus && setF(true)}
      onBlur={() => focus && setF(false)}
      {...rest}
    >
      {children}
    </As>
...
const products = [
  {
    ...
    title: "Accounts",
    short: "Create multi-currency sandbox accounts and receiving details.",
    ...
    rows: [
      { k: "CURRENCIES", v: "6 CONFIGURED" },
      { k: "DETAILS", v: "SAMPLE IBAN · SORT · ROUTING" },
      { k: "BALANCES", v: "LEDGER-BACKED" },
      { k: "MODE", v: "SANDBOX" },
    ],
  ...
  {
    glyph: "CD",
    screen: "cards" as Screen,
    tag: "CARDS",
    endpoint: "POST /v2/cards",
    title: "Cards",
    short: "Create sandbox cards and test controls and decisions.",
    ...
    rows: [
      { k: "TYPES", v: "VIRTUAL · PHYSICAL RECORDS" },
      { k: "CONTROLS", v: "LIMITS · MCC · FREEZE" },
      { k: "AUTHORISATIONS", v: "SANDBOX" },
      { k: "PROVIDER", v: "NOT INCLUDED" },
    ],
    code: 'fetch("/v2/cards", {\n  method: "POST",\n  headers: { "content-type": "application/json", "x-api-key": key },\n  body: JSON.stringify({ account: "acc_92f", form: "virtual" })\n});',
  },
  {
    glyph: "TR",
    screen: "transfers" as Screen,
    tag: "TRANSFERS",
    endpoint: "POST /v2/transfers",
    title: "Transfers",
    short: "Model transfers across six configured payment rails.",
    ...
    rows: [
      { k: "RAILS", v: "6 REFERENCE" },
      { k: "STATUS", v: "PER LEG" },
      { k: "CUT-OFFS", v: "QUERYABLE" },
      { k: "REAL MONEY", v: "NONE" },
    ],
  ...
  {
    glyph: "FX",
    screen: "exchange" as Screen,
    tag: "EXCHANGE",
    endpoint: "POST /v2/quotes",
    title: "Exchange",
    short: "Create expiring quotes for configured currency pairs.",
    ...
    rows: [
      { k: "PRICES", v: "REFERENCE DATA" },
      { k: "QUOTE HOLD", v: "30 SECONDS" },
      { k: "EXPIRY", v: "ENFORCED" },
      { k: "LIVE MARKET", v: "NOT INCLUDED" },
    ],
    code: 'fetch("/v2/quotes", {\n  method: "POST",\n  headers: { "content-type": "application/json", "x-api-key": key },\n  body: JSON.stringify({ from: "USD", to: "EUR", amount: "10000.00" })\n});',
  },
  {
    glyph: "VT",
    screen: "vaults" as Screen,
    tag: "VAULTS",
    endpoint: "POST /v2/vaults",
    title: "Savings vaults",
    short: "Model named balances, deposits, withdrawals and accrual.",
    ...
    rows: [
      { k: "RATE", v: "CONFIGURABLE" },
      { k: "ACCRUAL", v: "REFERENCE LOGIC" },
  ...
  {
    glyph: "CR",
    screen: "credit" as Screen,
    tag: "CREDIT",
    endpoint: "POST /v2/credit",
    title: "Credit lines",
    short: "Test limits, draws, repayments and collateral checks.",
    ...
    rows: [
      { k: "COLLATERAL", v: "PER LINE" },
      { k: "MAX LTV", v: "CONFIGURABLE" },
      { k: "DRAW", v: "LIMIT-CHECKED" },
      { k: "LENDER", v: "NOT INCLUDED" },
    ],
    code: 'fetch("/v2/credit", {\n  method: "POST",\n  headers: { "content-type": "application/json", "x-api-key": key },\n  body: JSON.stringify({ account: "acc_92f", limit: "25000.00" })\n});',
  },
  {
    glyph: "BZ",
    screen: "business" as Screen,
    tag: "BUSINESS",
    endpoint: "POST /v2/orgs",
    title: "Business banking",
    short: "Model organisations, roles, policies and approvals.",
    ...
    rows: [
      { k: "ROLES", v: "OWNER · ADMIN · MEMBER" },
      { k: "APPROVALS", v: "MULTI-STEP" },
      { k: "POLICIES", v: "ATTACHABLE" },
      { k: "HISTORY", v: "EVENT RECORDS" },
    ],
    code: 'fetch("/v2/orgs", {\n  method: "POST",\n  headers: { "content-type": "application/json", "x-api-key": key },\n  body: JSON.stringify({ name: "Kessler Ltd" })\n});',
  },
  {
    glyph: "LG",
    screen: "ledger" as Screen,
    tag: "LEDGER",
    endpoint: "GET /v2/ledger",
    title: "Ledger & statements",
    short: "Query double-entry records and create sandbox statements.",
    ...
    rows: [
      { k: "MODEL", v: "DOUBLE-ENTRY" },
      { k: "EXPORTS", v: "REFERENCE FORMATS" },
      { k: "EVENTS", v: "QUERYABLE" },
      { k: "MODE", v: "SANDBOX" },
    ],
  ...
  // products page, and link into the docs rather than pinning a hero screen.
  {
    ...
    short: "Model KYC and KYB application states and decisions.",
    ...
    rows: [
      { k: "ENDPOINTS", v: "14" },
      { k: "STATUS", v: "SEPARATE FROM DECISION" },
      { k: "DOCUMENTS", v: "UPLOAD · FETCH" },
      { k: "EDD", v: "MODELLED" },
    ],
  ...
  {
    glyph: "QR",
    screen: "deposit-onchain" as Screen,
    tag: "QR",
    endpoint: "POST /v2/qr/generate",
    title: "QR & payment links",
    short: "Generate and validate EMVCo QR payloads and link records.",
    ...
    rows: [
      { k: "STANDARD", v: "EMVCo MPM" },
      { k: "CHECKSUM", v: "CRC-16/CCITT" },
      { k: "TYPES", v: "STATIC · DYNAMIC" },
      { k: "TAMPERING", v: "REJECTED" },
    ],
  ...
  },
  {
    ...
    title: "Wallets",
    short: "Track sandbox balances and test policy-gated sends.",
  ...
  {
    glyph: "WH",
    screen: "deposit-pending" as Screen,
    tag: "WEBHOOKS",
    endpoint: "POST /v2/webhooks",
    title: "Webhooks & events",
    short: "Send signed callbacks, inspect deliveries and replay them.",
    ...
    rows: [
      ...
      { k: "HISTORY", v: "30 DAYS" },
      { k: "REPLAY", v: "X-WEBHOOK-REPLAY" },
      { k: "EVENTS", v: "REFERENCE RECORDS" },
    ],
    code: 'fetch("/v2/webhooks", {\n  method: "POST",\n  headers: { "content-type": "application/json", "x-api-key": key },\n  body: JSON.stringify({ url: "https://you.dev/hook", events: ["transfer.status_changed"] })\n});',
  },
  {
    glyph: "SB",
    screen: "card-declined" as Screen,
    tag: "SANDBOX",
    endpoint: "GET /v2/sandbox/scenarios",
    title: "Sandbox scenarios",
    short: "Trigger predefined failures and advance paused simulations.",
    ...
    rows: [
      { k: "SCENARIOS", v: "CATALOGUED" },
      { k: "PAUSE", v: "AWAITING_ADVANCE" },
      { k: "IDEMPOTENT", v: "ON SIMULATION ID" },
      { k: "CALLBACKS", v: "TRACKED" },
    ],
    code: 'fetch("/v2/sandbox/onboarding", {\n  method: "POST",\n  headers: { "content-type": "application/json", "x-api-key": key },\n  body: JSON.stringify({ scenario: "onboarding.compliance_hold" })\n});',
  },
  {
    glyph: "BL",
    screen: "funded-home" as Screen,
    tag: "BILLS",
    endpoint: "POST /v2/mandates",
    title: "Bills & subscriptions",
    short: "Model mandates and recurring payment schedules.",
    ...
    rows: [
      { k: "MANDATES", v: "SCHEME-AWARE" },
      { k: "SCHEDULE", v: "INTERVAL + NEXT RUN" },
      { k: "GUARD", v: "INACTIVE → 409" },
      { k: "ENDPOINTS", v: "4" },
    ],
...
const guides = [
  {
    kind: "GUIDE",
    title: "Idempotency",
    body: "Retry write requests without creating the same sandbox object twice.",
  },
  {
    kind: "GUIDE",
    title: "Card authorisations",
    body: "Simulate an authorisation and record an approve or decline decision.",
  },
  {
    kind: "RUNBOOK",
    title: "Run it locally",
    body: "Install the packages and start the site, banking API and FX node with pnpm dev.",
  },
];
const counters = [
  {
    title: "Issue tracking",
    body: "GitHub issues, open to anyone: github.com/Josh-Gi3r/blueballs/issues.",
  },
  {
    title: "Run it locally",
    body: "git clone, pnpm install, pnpm dev. The hosted sandbox is there if you would rather not.",
  },
  {
    title: "Security",
    body: "Private vulnerability reporting through GitHub security advisories. See SECURITY.md.",
  },
];
const footer = [
  {
  ...
  },
  {
    head: "PROJECT",
    links: [
      ["Source on GitHub", "https://github.com/Josh-Gi3r/blueballs"],
      [
        "Report a vulnerability",
        "https://github.com/Josh-Gi3r/blueballs/security/advisories/new",
      ],
      ["Contact", "/contact"],
    ],
  },
...
function GridFillers({ count }: { count: number }) {
  return (
    <>
      {([2, 3, 4] as const).flatMap((columns) => {
        const missing = (columns - (count % columns)) % columns;
        return Array.from({ length: missing }, (_, index) => {
          const [label, copy] =
            GRID_FILLER_COPY[index % GRID_FILLER_COPY.length];
          return (
            <div
              aria-hidden="true"
              className={`bb-grid-filler bb-fill-cols-${columns}`}
              key={`${columns}-${index}`}
            >
              <span>{label}</span>
              <strong>{copy}</strong>
              <small>BLUEBALLS · MIT LICENCE</small>
            </div>
          );
        });
      })}
...
export default function App() {
  ...
  const selectDirectory = (nextPath: "/cards" | "/ecosystem") => {
    setMobileNavOpen(false);
    go(nextPath);
  };
  const openSandbox = () => {
  ...
  useEffect(() => {
    let alive = true;
    getStats().then((s) => {
      if (alive) s ? setStats(s) : setStatsErr(true);
    });
    return () => {
      alive = false;
    };
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const out: string[] = [];
      if (r.ok) {
        for (const rail of (r.body as any).data as Array<{
          id: string;
          speed: string;
          cutoff: string | null;
        }>) {
          ...
          out.push(
            rail.cutoff
              ? `${label} CUT-OFF ${rail.cutoff}`
              : `${label} · ${rail.speed.toUpperCase()}`,
          );
        }
      }
      out.push(
        page === "fx"
          ...
          : "REFERENCE SANDBOX · NO REAL MONEY MOVES",
      );
      if (stats) {
        ...
        out.push(
          `ENDPOINTS AVAILABLE ${stats.endpoints_implemented}/${stats.endpoints_catalogued}`,
        );
      }
      setTicks(
        out.length ? out : ["SANDBOX DATA UNAVAILABLE — IS THE API RUNNING?"],
      );
    })();
    return () => {
      alive = false;
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const r = await call("POST", "/v2/quotes", {
        from: "EUR",
        to: "USD",
        amount: "1000.00",
      });
      if (!alive) return;
      if (r.ok) setQuoteMs(r.ms);
      else setQuoteErr(true);
    })();
    return () => {
      alive = false;
    };
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (!alive) return;
      if (r.ok) setFxQuote(r.body as FxQuote);
      else setFxErr(true);
    })();
    return () => {
      alive = false;
  ...
  const shownFamilies = !q
    ? FAMILIES
    : FAMILIES.map((f) => ({
        ...f,
        endpoints: f.name.toLowerCase().includes(q)
          ? f.endpoints
          : f.endpoints.filter(
              (e) =>
    ...
    >
      ...
      >
        ...
        >
          {nav.map((t) => (
            <H
              ...
              style={{
                ...
                border: "none",
                borderRadius: 8,
                background: page === t.key ? "#F0F2F7" : "transparent",
                color: page === t.key ? "#07144F" : "#5B6376",
              }}
              hover={{ color: "#07144F" }}
            >
              {t.label}
          ...
          <H
            as="button"
            onClick={() => selectDirectory("/ecosystem")}
            style={{
              fontSize: 13.5,
              fontWeight: 500,
              padding: "9px 14px",
        ...
        <H
          ...
          hover={{ background: "#0868FF", border: "1px solid #0868FF" }}
        >
          Try the sandbox
        </H>
        <button
        ...
        {mobileNavOpen && (
          ...
          >
            ...
            <button type="button" onClick={() => selectDirectory("/cards")}>
              Cards
            </button>
            <button type="button" onClick={() => selectDirectory("/ecosystem")}>
              Providers
            </button>
            <button
      ...
      >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <br />
                  for building a neobank.
                  <br />
                  <span style={{ color: "#0868FF" }}>
                    Run it. Read it. Extend it.
                  </span>
                </h1>
                <p
                  style={{
                ...
                >
                  Blueballs is free, MIT-licensed software for accounts, cards,
                  transfers, onboarding, ledger and FX. Create a sandbox key
                  yourself, run the code locally and connect the services your
                  production deployment needs. The goal is to lower the cost of
                  building financial products so more teams can serve people
                  traditional banks overlook or exclude.
                </p>
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                  ...
                  <H
                    ...
                    hover={{ boxShadow: "inset 0 0 0 1px #07144F" }}
                  >
                    Read the docs
                  </H>
                </div>
                  ...
                  >
                    {active.rows.map((sf) => (
                      <span key={sf.k}>
                        ...
                        <span style={{ fontWeight: 500, color: "#07144F" }}>
                          {sf.v}
                        </span>
                      </span>
                    ))}
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                  {products
                    ...
                    .map((p) => {
                      ...
                      return (
                        <H
                          key={`${p.screen}-${p.title}`}
                          as="button"
                          onClick={show(p.screen!)}
                          style={{
                            cursor: "pointer",
                            fontSize: 12,
                            fontWeight: 500,
                            padding: "7px 12px",
                            borderRadius: 999,
                            border: `1px solid ${on ? "#0868FF" : "#D7DBE4"}`,
                            background: on ? "#0868FF" : "#FFFFFF",
              ...
              {products.map((p) => {
                ...
                return (
                  <H
                    key={p.title}
                    onClick={() => {
                      if (p.screen) show(p.screen)();
                      else setPage("dev");
                    }}
                    style={{
                      background: on ? "#F4F6FB" : "#FFFFFF",
                      border: `1px solid ${on ? "#0868FF" : "#D7DBE4"}`,
                      borderRadius: 16,
                      padding: "22px 20px 20px",
                      display: "flex",
            ...
            >
              ...
              >
                ...
                {totals.map((t) => (
                  ...
                  >
                    <div style={{ fontSize: 14.5, color: "#454B5C" }}>
                      {t.label}
                    </div>
                    <div
                      style={{
            ...
            >
              ...
              >
                ...
                >
                  Create a sandbox key here, or clone the repository and run the
                  full reference stack locally.
                </div>
              </div>
              <H
                as="button"
        ...
        {page === "products" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <div data-pad style={{ ...card, padding: "46px 46px 40px" }}>
              ...
              >
                Banking product models you can run and inspect.
              </h1>
              <p
                style={{
                  margin: 0,
              ...
              >
                The repository models accounts, cards, transfers, onboarding,
                ledger, wallets and more behind one reference API. Use these
                flows as a starting point, then connect the services and
                controls required for production.
              </p>
            </div>
            <div
              style={{
            ...
            >
              <div>
                ...
                >
                  Inspect the canonical FX reference flow.
                </div>
                <div
                  style={{
                    fontSize: 14.5,
                ...
                >
                  Follow one BRL-to-EUR request through policy checks, source
                  selection, reservation and mixed-finality settlement.
                </div>
              </div>
              <div
                style={{
            ...
            <div
              data-pad
              style={{ ...card, padding: "34px 34px 30px", marginTop: 4 }}
            >
              <div
                style={{
                  display: "flex",
              ...
              >
                <div>
                  ...
                  >
                    {FAMILIES.length} resource families. {TOTAL_ENDPOINTS}{" "}
                    endpoints.
                  </h2>
                </div>
                <H
              ...
              >
                The API groups {TOTAL_ENDPOINTS} catalogued endpoints into{" "}
                {FAMILIES.length} resource families. Each one is available in
                the hosted reference sandbox.
              </p>
              <div className="bb-product-grid">
                {FAMILIES.map((f) => (
                  <H
                    ...
                    hover={{
                      boxShadow: "inset 0 0 0 1px #0868FF",
                      background: "#FFFFFF",
                    }}
                  >
                    <div
          ...
          >
            <div className="bb-toc" style={{ ...card, padding: "22px 0 24px" }}>
              ...
              {[
                ...
                { label: "Guides & runbooks", id: "doc-guides" },
              ].map((item) => (
                <H
                  key={item.id}
                  ...
                  hover={{ color: "#0647E8", background: "#F0F2F7" }}
                >
                  {item.label}
                </H>
              ))}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              >
                ...
                >
                  Create a sandbox key, send JSON requests with the x-api-key
                  header and inspect the responses. This is reference behaviour,
                  not a production banking service.
                </p>
              </div>
              <div
                data-col
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      {TOTAL_ENDPOINTS} ENDPOINTS · {FAMILIES.length} FAMILIES
                    </div>
                  </div>
                </div>
                <div style={{ marginTop: 14 }}>
                  ...
                  >
                    These endpoints run against the hosted sandbox. They create
                    reference data and never move real money or call production
                    providers.
                  </div>
                  <KeyIssuer />
                </div>
                ...
                {shownFamilies.map((fam) => (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {fam.endpoints.length} ENDPOINTS
                      </span>
                    </div>
                    <p
                      style={{
                    ...
                    <div data-scroll>
                      <div>
                        {fam.endpoints.map((e, i) => (
                          <div
                            key={i}
                            className="bb-endpoint"
                            style={{
                              display: "grid",
                              gridTemplateColumns: "62px 1.4fr 1.4fr 62px 74px",
                              alignItems: "center",
                              gap: 10,
                              padding: "10px 6px",
                              borderTop: "1px solid #E7EAF0",
                          ...
                          >
                            ...
                            <div style={{ fontSize: 13.5, color: "#454B5C" }}>
                              {e.does}
                            </div>
                            <div
                              style={{
                                ...
                                fontSize: 10,
                                color:
                                  e.access === "PUBLIC" ? "#2E7D53" : "#7A8296",
                              }}
                            >
                              {e.access}
                            </div>
                            <div style={{ textAlign: "right" }}>
                              <TryIt verb={e.verb} path={e.path} />
                            </div>
                          </div>
                        ))}
                      </div>
        ...
        {page === "contact" && (
          ...
          >
            <div data-pad style={{ ...card, padding: "42px 40px 38px" }}>
              ...
              >
                The source, the issue tracker and private vulnerability
                reporting are all open at{" "}
                <a
                ...
                . Sandbox keys are in the developer guide.
              </p>
              <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                <a
                  href="/developers"
                  style={{ ...ink, display: "inline-block" }}
                >
                  Use the sandbox
                </a>
                <a
              ...
              >
                Issues and security advisories are the routes in. Both go to the
                same people.
              </p>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            >
              MIT-licensed reference software for building neobank products.
            </div>
            <div
              style={{
                fontFamily: MONO,
            ...
            >
              ...
              {col.links.map(([label, href]) => (
                <a
                  key={label}
                  href={href}
                  style={{ fontSize: 13.5, color: "#E4E7EE" }}
                >
                  {label}
                </a>
              ))}
