...
export function sitemapXml() {
  ...
  return `<?xml version="1.0" encoding="UTF-8"?><urlset xmlns="http://www.sitemaps.org/sitemap/0.9">${entries}</urlset>`;
}
